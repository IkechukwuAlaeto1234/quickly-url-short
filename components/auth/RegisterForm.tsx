...
export const RegisterForm: React.FC<RegisterFormProps> = ({ onRegister }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <label htmlFor="register-email" className="block text-sm font-bold text-slate-700 mb-1">Email Address</label>
        <input
          id="register-email"
          type="email"
          value={email}
      ...
      <div>
        ...
        <label htmlFor="register-password" className="block text-sm font-bold text-slate-700 mb-1">Password</label>
        <input
      ...
      <div>
        {/* FIX: Added missing className attribute. */}
        <label htmlFor="confirm-password" className="block text-sm font-bold text-slate-700 mb-1">Confirm Password</label>
        <input
          id="confirm-password"
          type="password"
